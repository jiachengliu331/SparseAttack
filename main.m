function main(varargin)
    ...
    addOptional(parser,"maxnumber",100);

    addOptional(parser,"Pro",'PO',@ischar);
    addOptional(parser,"A_attacked",'MOEARE',@ischar);
    addOptional(parser,"A_attack",'SparseEA',@ischar);
