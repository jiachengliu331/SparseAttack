...
%           [originbest,AttackedAlgorithm,AttackedProblem] = Algorithm.ParameterSet(0,"?","?");
            ...
            Population = Problem.Evaluation(Dec.*Mask);
            [Population,Dec,Mask,FrontNo,CrowdDis] = EnvironmentalSelectionSparseEA([Population,TempPop],[Dec,TDec],[Mask,TMask],Problem.N);
            ...
            while Algorithm.NotTerminated(Population)
                ...
                [Population,Dec,Mask,FrontNo,CrowdDis] = EnvironmentalSelectionSparseEA([Population,Offspring],[Dec;OffDec],[Mask;OffMask],Problem.N);
            end
        end
    end
end