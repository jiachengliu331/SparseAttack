...
%--------------------------------------------------------------------------
    ...
    methods
        function main(Algorithm,Problem)
            ...
            [Population,Dec,Mask,FrontNo,CrowdDis] = EnvironmentalSelectionS([Population,TempPop],[Dec,TDec],[Mask,TMask],Problem.N);
            ...
            while Algorithm.NotTerminated(Population)
                ...
                [Population,Dec,Mask,FrontNo,CrowdDis] = EnvironmentalSelectionS([Population,Offspring],[Dec;OffDec],[Mask;OffMask],Problem.N);          
            end
